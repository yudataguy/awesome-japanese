...
- **Generative AI:** add the `:robot:` emoji if generative AI was involved either way — the item was **built with** generative AI (AI-assisted or AI-generated code/content during development) *or* the item **uses** generative AI in the product itself (e.g. an AI tutor, AI-graded practice, or AI-generated example sentences). This is a neutral tag for transparency, not a judgment of quality. See the emoji legend at the top of the [readme](readme.md).
