...
<!-- Generative AI: add the `:robot:` emoji if the item was built with generative AI or uses it in the product itself. -->
...
- [ ] Generative AI is marked correctly: I added the `:robot:` emoji if the item was built with generative AI or uses it in the product itself
